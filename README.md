...
## Results
The results obtained look very promising. Results after training the model for 150 and 250 epochs on the extended dataset (RGB + BGR versions of training images) look like this.
